...
WITH room_type_templates (name, max_occupancy, image_url) AS (
    VALUES
        ...
        ('주니어 스위트', 3, 'https://images.unsplash.com/photo-1590073242678-70ee3fc28f8e?w=500&auto=format&fit=crop&q=60'),
        ('로열 스위트', 4, 'https://images.unsplash.com/photo-1601565415267-e5d0c7a10cc5?w=500&auto=format&fit=crop&q=60'),
